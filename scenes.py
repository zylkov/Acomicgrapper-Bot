...
def start(bot, update):
    text = """**Добро пожаловать!**  :wave: :smile:
Я помогу вам в поисках комикса на сайте   
:heart: [acomic.ru](https://acomics.ru) :heart:, а также скачаю страницы специально для вас. 
